...
class Projects extends Component {
    ...
    buttonHandler(){
        return(
            alert("This is Infosys ongoing project, Hence code is not available")
        )
    }
                ...
                <Grid>  
                    <Cell col={4}>         
                            ...
                            <Card shadow={0} className="card">
                                    ...
                                    <CardText>
                                    Currently working on this project as a React developer. We are developing a ecommerce 
                                    portal for Infosys employees so that they can purchase groceries items from the Infosys store.
                                    
                                    </CardText>
                                    <CardActions border>
                                        <Button onClick={() => this.buttonHandler()} colored>GitHub</Button>
                                    </CardActions>
